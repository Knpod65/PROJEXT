...
| 4. Frontend Base Path + API Proxy Readiness | 65 | Audit complete. Safe Vite + env support recommended (not yet implemented in this pass). Current root deployment works. | Sub-path support not yet in main branch | Low | High | High |
