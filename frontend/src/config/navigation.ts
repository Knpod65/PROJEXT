...
export const appPages: AppPageConfig[] = [
   ...
   },
  {
    ...
    description: "Fair-duty analytics for invigilation and paper distribution.",
  ...
  {
    key: "workload-duty-analytics-staff",
    title: "Duty Workload",
    description: "Fair-duty analytics for invigilation and paper distribution.",
    path: "/duty-workload",
    icon: "bar_chart",
    roles: ["staff", "dept_supervisor", "esq_head", "secretary"],
    navGroup: "dashboard",
  },
  {
    key: "workload-duty-analytics-teacher",
    title: "My Workload",
    description: "Teacher workload analytics for invigilation and paper distribution.",
    path: "/my-workload",
    icon: "bar_chart",
    roles: ["teacher"],
    navGroup: "dashboard",
